...
function Test17_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = log_temperature)
    name               = "Test17_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    ...
    while !stop
        ...
        result                     = Tests_probabilistic_improvement(tuning_run, threshold = p, distance = 0.3, RandPercentage = 0.5, NbVaribleMutate = 10)
...
function Test18_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = log_temperature)
    name               = "Test18_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
    ...
    while !stop
        iteration                 += 1
        p                          = temperature(iteration)
        result                     = Tests_probabilistic_improvement(tuning_run, threshold = p, distance = 0.3, RandPercentage = 0.0, NbVaribleMutate = 10)
        cost_calls                += result.cost_calls
        result.cost_calls          = cost_calls
        result.start               = tuning_run.starting_point
        result.technique           = (result.technique != "MP Probabilistic Improvement")? result.technique : name
...
function Test19_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = log_temperature)
    name               = "Test19_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
    ...
    while !stop
        iteration                 += 1
        p                          = temperature(iteration)
        result                     = Tests_probabilistic_improvement(tuning_run, threshold = p, distance = 0.3, RandPercentage = 1.0, NbVaribleMutate = 10)
        cost_calls                += result.cost_calls
        result.cost_calls          = cost_calls
        result.start               = tuning_run.starting_point
        result.technique           = (result.technique != "MP Probabilistic Improvement")? result.technique : name
...
function Test20_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = logx10_temperature)
    name               = "Test20_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test21_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = logx10_temperature)
    name               = "Test21_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test22_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = logx10_temperature)
    name               = "Test22_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test23_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = log_temperature)
    name               = "Test23_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
    ...
    while !stop
        iteration                 += 1
        p                          = temperature(iteration)
        result                     = Tests_probabilistic_improvement(tuning_run, threshold = p, distance = 0.5, RandPercentage = 0.5, NbVaribleMutate = 10)
        cost_calls                += result.cost_calls
        result.cost_calls          = cost_calls
        result.start               = tuning_run.starting_point
        result.technique           = (result.technique != "MP Probabilistic Improvement")? result.technique : name
...
function Test24_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = logx10_temperature)
    name               = "Test24_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
