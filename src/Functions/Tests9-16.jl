...
function Test9_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = log_temperature)
    name               = "Test9_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
...
function Test10_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = log_temperature)
    name               = "Test10_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test11_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = log_temperature)
    name               = "Test11_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test12_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = logx10_temperature)
    name               = "Test12_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test13_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = logx10_temperature)
    name               = "Test13_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test14_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = logx10_temperature)
    name               = "Test14_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test15_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = log_temperature)
    name               = "Test15_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
...
function Test16_simulated_annealing(tuning_run::MPRun,
                                   reference::RemoteChannel;
                                   temperature::Function = logx10_temperature)
    name               = "Test16_Simulated Annealing $(myid())"
    iteration          = 1
    cost_calls         = tuning_run.cost_evaluations
    stopping_criterion = @task tuning_run.stopping_criterion(tuning_run.duration)
    stop               = consume(stopping_criterion)
